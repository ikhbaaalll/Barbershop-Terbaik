                                            ...
                                            <div class="col-sm">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="barber_name" value="{{ old('barber_name') }}"
                                                        class="form-control @error('barber_name') is-invalid @enderror"
                                                        required autocomplete="off" placeholder="Barber name">
                                                </div>
                                            </div>
                                            <div class="col-sm">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="price" value="{{ old('price') }}"
                                                        ...
                                                        autocomplete="off" placeholder="Barber price">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <textarea name="address" id="address" cols="5"
                                                ...
                                                placeholder="Barber Address">{{ old('address') }}</textarea>
                                        </div>
                                        <div class="form-group">

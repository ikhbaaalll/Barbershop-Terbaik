...
<body>
    <div class="calendar inactive"> 
        <input id="calendar1-input" class="calendar-input " placeholder="mm/dd/yy" type="text" value="">
        <img class="cld-img" src="https://res.cloudinary.com/dfky4apck/image/upload/v1561494024/calendar.png">
    </div>
    <br><br><br><br>
    <div class="calendar inactive"> 
        <input id="calendar2-input" class="calendar-input " placeholder="mm/dd/yy" type="text" value="">
        <img class="cld-img" src="https://res.cloudinary.com/dfky4apck/image/upload/v1561494024/calendar.png">
    </div>
    ...
    <script>
        ...
        var grid = `<caption><img id="up" src="https://res.cloudinary.com/dfky4apck/image/upload/v1561494024/up.png"><span>${
            monthName[focusD.getMonth()]
        } ${focusD.getFullYear()}</option>
        </span><img id="down" src="https://res.cloudinary.com/dfky4apck/image/upload/v1561494024/down.png">
        </caption>
        <tr>
            <th>Su</th>
            <th>M</th>
        ...
        if (e.target.classList.contains("cld-img")) {
            constructPicker(e, getCurrentDateStr(), "N/A", "");
        }
        });
        var calendar2 = document.getElementById("calendar2-input").parentElement;
        calendar2.addEventListener("click", e => {
        if (e.target.classList.contains("cld-img")) {
            constructPicker(e, "01-01-0001", "N/A", "1 4");
        }
        });
